...
export async function createApp({
  ...
  console.log(`Creating a new Pilot.js app in ${chalk.green(root)}.`)
  console.log()
  ...
  if (hasPackageJson) {
    ...
    console.log('    Builds the app for production. (or development in native)')
    console.log()
    console.log(chalk.cyan(`  ${packageManager} start:native`))
    console.log('    Runs the app powered by Expo and Pilot.js.')
    console.log()
    console.log(chalk.cyan(`  ${packageManager} start:web`))
    console.log('    Runs the built app in production mode powered by Next.js.')
    console.log()
