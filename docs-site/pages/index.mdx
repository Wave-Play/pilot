...
- [Advanced setup for Next.js](/docs/advanced-nextjs)
- [Caching](/docs/caching)
- [Command line interface](/docs/cli)
- [Configuration](/docs/configuration)
- [Environment variables](/docs/environment-variables)
- [Internationalized routing](/docs/i18n)
- [Managed entry](docs/managed-entry)
- [Web props](/docs/web-props)
...
| `/pages`             | <center>✅</center> | Automatically finds routes from `/pages` or `/src/pages` directory via [`pilot build`](/docs/cli) command. |
...
| `i18n`               | <center>✅</center> | Supports `defaultLocale` and `locales` from next.config.js `i18n` fields. `locale` is passed as a variable in your getProps functions. [Learn more](/docs/i18n). |
...
| `context`            | <center>🕒</center> | `context` is passed to `getServerSideProps` and `getStaticProps` functions. If haven't [set up Web Props](/docs/web-props), `req` and `res` will be empty objects.<br/><br/>Fields not supported yet:<br/>`preview`, `previewData` |
